...
- [[output/website/trust-bundle/_manifest|Trust Bundle (compiled)]] — `output/website/trust-bundle/*.json`. Generated by `scripts/compile_trust.py` from claim/evidence/entity/decision registries + conflict-log + aeo-claims narrative. **Status (2026-05-28):** v1 compiler shipped on `feat/trust-bundle-compiler-v1`; real-data compile blocked on DQ-001/002/003 (CONF-001/002/003 require Sam verdict to lock in `raw/_manifest/decision-registry.yml`).
