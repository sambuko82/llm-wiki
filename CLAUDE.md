...
**Build status:** — wiki-only (no code build). 9/9 trust-bundle JSON files valid (+3 schema/); master doc + schema verified; 9/9 price spot-checks match SSOT; 10/10 legal/trust identifiers cross-checked.
**Open items:**
