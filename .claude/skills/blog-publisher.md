...
### Post frontmatter (all fields required except banner_image)
...
Available banner images (absolute paths, served from jvto-web public/):
- `/assets/img/hero/ijen.jpg` — Kawah Ijen crater
- `/assets/img/hero/bali.jpg` — Bali departure
- `/assets/img/hero/surabaya.jpg` — Surabaya departure
- `/assets/img/hero/home.webp` — general volcano scenery

Pick the most relevant. Omit `banner_image` only if no available image fits the topic.
...
4. State the proposed slug, title, tags, SEO description, and banner_image
...
1. Write `output/website/blog/<slug>.md` (frontmatter + body, including banner_image)
2. Add/update entry di `output/website/blog/_manifest.json` (status: "draft", include banner_image)
...
Tags:     ijen, safety, guide
Read:     ~5 min
Banner:   /assets/img/hero/ijen.jpg
