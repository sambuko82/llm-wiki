...
page: /tours/from-bali/ijen-bromo-madakaripura-3d2n
...
# Tour Page Data Structure: /tours/from-bali/ijen-bromo-madakaripura-3d2n

> Tour data fetched from DB at runtime. This file defines display schema only.
> Tour name (DB): 3 Day Ijen, Bromo & Madakaripura Waterfall Journey from Bali to Surabaya
...
| `duration_badge` | DB → `tours.duration` | Display as badge: "3D2N" |
...
| Duration | DB → `tours.duration` | "3 Days / 2 Nights" |
...
| Each day: `day_number` | DB | e.g., "Day 1", "Day 2", "Day 3" |
