...
# Tour Page Data Structure: /tours/from-surabaya/ijen-2d1n

> Tour data fetched from DB at runtime. This file defines display schema only.
> Tour name (DB): 2 Day Ijen Blue Fire Expedition from Surabaya
...
- **Bromo Jeep line in inclusions**: HIDE — no Bromo on this package
