...
page: /tours/from-surabaya/ijen-bromo-madakaripura-3d2n
...
# Tour Page Data Structure: /tours/from-surabaya/ijen-bromo-madakaripura-3d2n

> Tour data fetched from DB at runtime. This file defines display schema only.
> Tour name (DB): 3 Day Ijen, Bromo & Madakaripura Waterfall Discovery from Surabaya
...
- Package includes solo (1 pax) tier per pricing benchmarks.
