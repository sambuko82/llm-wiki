...
# Tour Page Data Structure: /tours/from-surabaya/bromo-madakaripura-ijen-3d2n

> Tour data fetched from DB at runtime. This file defines display schema only.
> Tour name (DB): 3 Day Bromo, Madakaripura & Ijen Overland from Surabaya to Bali
...
| `terminus_city` | DB → `tours.terminus` | Display as badge: "Ends in Bali" |
...
| Ends In | DB → `tours.terminus` | "Bali" — display when terminus ≠ origin |
...
- **Terminus badge / "Ends in Bali" row**: SHOW — `terminus: bali`
- **Terminus advisory**: SHOW — "Confirm onward travel from Bali before booking."
- **Bromo Jeep line in inclusions**: SHOW — Bromo is in this package
- **Ferry crossing line in inclusions**: HIDE — crossing is on Java side; no Bali→Java ferry on this route

---

## Notes

- `terminus: bali` — this tour starts in Surabaya and ends in Bali.
- Display advisory: "Confirm onward travel from Bali before booking."
