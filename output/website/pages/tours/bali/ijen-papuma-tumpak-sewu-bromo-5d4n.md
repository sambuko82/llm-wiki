...
page: /tours/from-bali/ijen-papuma-tumpak-sewu-bromo-5d4n
...
# Tour Page Data Structure: /tours/from-bali/ijen-papuma-tumpak-sewu-bromo-5d4n

> Tour data fetched from DB at runtime. This file defines display schema only.
> Tour name (DB): 5 Day Ijen, Papuma Beach, Tumpak Sewu & Bromo Discovery from Bali to Surabaya
...
| `duration_badge` | DB → `tours.duration` | Display as badge: "5D4N" |
...
| Duration | DB → `tours.duration` | "5 Days / 4 Nights" |
...
| Each day: `day_number` | DB | e.g., "Day 1" through "Day 5" |
