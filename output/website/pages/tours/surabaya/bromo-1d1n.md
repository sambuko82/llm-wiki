...
page: /tours/from-surabaya/bromo-1d1n
...
# Tour Page Data Structure: /tours/from-surabaya/bromo-1d1n

> Tour data fetched from DB at runtime. This file defines display schema only.
> Tour name (DB): 1 Day Bromo Midnight Experience from Surabaya
...
| `duration_badge` | DB → `tours.duration` | Display as badge: "1D1N" |
...
| Duration | DB → `tours.duration` | "1 Day / 1 Night" |
...
| Each day: `day_number` | DB | e.g., "Day 1" |
