...
schema_file: ijen-papuma-tumpak-sewu-bromo-4d3n-schema.json
profile: schema (TouristTrip + AggregateRating + FAQPage)
tour_url: /tours/from-surabaya/ijen-papuma-tumpak-sewu-bromo-4d3n
---

# Verification Receipt — ijen-papuma-tumpak-sewu-bromo-4d3n-schema.json

| Claim | Value used | SSOT source | Last verified | Drift risk |
|---|---|---|---|---|
| Tour name | "4 Day Ijen, Papuma Beach, Tumpak Sewu & Bromo Journey from Surabaya" | user-supplied brief 2026-05-18 | — | None |
...
| Itinerary Day 1–4 | SUB→Bondowoso·Ijen→Papuma side·Papuma Beach→Tumpak Sewu side·Tumpak Sewu+Bromo→SUB | user-supplied brief 2026-05-18 | — | None |
| Hotels | Day 1: Riverside Homestay · Day 2: Doho Homestay · Day 3: Joglo Kecombrang Bromo | user-supplied brief 2026-05-18 | — | Low |
...
| Inclusion list | Private transport, crew, 3 nights + breakfast, fees, 4WD jeep (Bromo), gas masks + trekking poles (Ijen), screening, water, T-shirt | user-supplied brief 2026-05-18 | — | Low |
| Geo: Kawah Ijen | lat -8.0580, lon 114.2420, Banyuwangi | SSOT pre-loaded 2026-05-18 | — | None |
| Geo: Papuma Beach | lat -8.2167, lon 113.6167, Jember | SSOT pre-loaded 2026-05-18 | — | None |
