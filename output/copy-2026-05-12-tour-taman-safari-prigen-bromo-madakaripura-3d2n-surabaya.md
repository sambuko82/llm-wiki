...
page: /tours/from-surabaya/taman-safari-prigen-bromo-madakaripura-3d2n
...
origin: surabaya
duration: 3D2N
destination_note: "Taman Safari Prigen is a wildlife and safari park in Prigen, East Java (near Pasuruan). No Ijen inclusion on this package."
---

# Tour Page Data Structure: /tours/from-surabaya/taman-safari-prigen-bromo-madakaripura-3d2n

> Tour data fetched from DB at runtime. This file defines display schema only.
> Tour name (DB): 3 Day Taman Safari Prigen, Bromo & Madakaripura from Surabaya
...
| Destination Note | Static | "Taman Safari Prigen is a wildlife and safari park in Prigen, East Java (near Pasuruan). No Ijen inclusion on this package." |
...
| Entrance fees and permits | Static (Policy) | All confirmed itinerary sites — including Taman Safari Prigen |
...
- **Destination Note**: SHOW — display `destination_note` in At a Glance table
...
- `destination_note`: "Taman Safari Prigen is a wildlife and safari park in Prigen, East Java (near Pasuruan). No Ijen inclusion on this package."
- Package confirmed via sitemap 2026-05-12. Full pricing and itinerary sourced from DB at runtime.
