...
page: /tours/from-surabaya/ijen-papuma-tumpak-sewu-bromo-malang-6d5n
...
# Tour Page Data Structure: /tours/from-surabaya/ijen-papuma-tumpak-sewu-bromo-malang-6d5n

> Tour data fetched from DB at runtime. This file defines display schema only.
> Tour name (DB): 6 Day Ijen, Papuma Beach, Tumpak Sewu, Bromo & Malang City Discovery from Surabaya
...
| `duration_badge` | DB → `tours.duration` | Display as badge: "6D5N" |
...
| Each day: `day_number` | DB | e.g., "Day 1" through "Day 6" |
...
- This is the longest available package (6D5N) — full East Java circuit.
