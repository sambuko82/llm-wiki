...
page: /policy/booking-payment-cancellation
...
- Where health screening or permit conditions are imposed by authorities (e.g., Mount Ijen):
...
JVTO offers FOC (Free of Charge) incentives for direct bookings (website and WhatsApp only). Not applicable to GetYourGuide, Booking.com, or other third-party platforms.

| Paying pax | FOC seats | Additional benefit |
|------------|-----------|-------------------|
| 18 paying pax | 1 FOC | — |
| 35 paying pax | 2 FOC | — |
| 50 paying pax | 3 FOC | + 5% discount for entire group |

"Pax" refers to **paying guests only**. FOC slot(s) do not count toward the paying threshold.
...
*For questions about this policy, contact: hello@javavolcano-touroperator.com · WhatsApp +62 822-4478-8833*
